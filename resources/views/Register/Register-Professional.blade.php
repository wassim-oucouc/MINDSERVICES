...
<nav class="bg-white shadow-sm">
        ...
        <div class="space-y-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="relative input-group">
                                        ...
                                        <label class="floating-label" for="firstname">Prénom</label>
                                    ...
                                    <div class="relative input-group">
                                        <input  id = "nom" name = "Nom" class="w-full px-4 py-3.5 rounded-lg input-field focus:outline-none font-medium transition-all" 
                                            type="text"  placeholder=" " >
                                        <label class="floating-label" for="lastname">Nom</label>
                                ...
                                <div class="relative input-group">
                                    <select name = "service" class="w-full px-4 py-3.5 rounded-lg input-field focus:outline-none font-medium transition-all appearance-none" 
                                        id="service" >
                                    ...
                                    <label class="floating-label" for="service">Service principal proposé</label>
                                ...
                                <button id = "suivant"  name = "send" class="w-full btn-professional text-white px-6 py-4 rounded-lg font-medium transition-all focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 text-lg">
                                    Suivant
                                </button>
                            </div>
    </div>
    ...
    <div id="secondform">
        ...
        <!-- Vos champs de la deuxième étape ici -->
        <div class="space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">

        </div>
        <div class="relative input-group">
            <input  name="Adresse" class="w-full px-4 py-3.5 rounded-lg input-field focus:outline-none font-medium transition-all" 
                type="text" id="adresse" placeholder=" " >
            <label class="floating-label" for="email">Adresse Professional</label>
            <span id="adresse-error" class="text-red-500 text-xs"></span>
        </div>
        <div class="relative input-group">
            <input 
            
             name="Ville" class="w-full px-4 py-3.5 rounded-lg input-field focus:outline-none font-medium transition-all" 
                type="text" id="Ville" placeholder=" " >
            <label class="floating-label" for="Ville">Ville</label>
            <span id="ville-error" class="text-red-500 text-xs">Le mot de passe est requis.</span>

        </div>
        <div class="relative input-group">
            <input name="PostalCode" class="w-full px-4 py-3.5 rounded-lg input-field focus:outline-none font-medium transition-all" 
                type="tel" id="PostalCode" placeholder=" " >
            <label class="floating-label" for="posta">Postal Code</label>
            <span id="postal-error" class="text-red-500 text-xs"></span>
        </div>
        <div class="relative input-group">
            <select  id = "pays" name = "pays" class="w-full px-4 py-3.5 rounded-lg input-field focus:outline-none font-medium transition-all appearance-none"  >
                <option value="" disabled selected></option>
            ...
            <label class="floating-label" for="service">Pays</label>
        ...
        <div class="flex items-start">
            <div class="flex items-center h-6">
                <input value="{{ csrf_token() }}" type="checkbox" id="terms" 
                    class="h-5 w-5 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded transition-all cursor-pointer">
            </div>
            <div class="ml-3">
                <label for="terms" class="text-sm text-gray-700">
        ...
        <div class="flex flex-col space-y-4">
            ...
            <button id = "inscription" type="submit" name="send" class="w-full btn-professional text-white px-6 py-4 rounded-lg font-medium transition-all focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 text-lg" type="submit">
                Inscription
            </button>
        </div>
    </div>
