                        ...
                        <tr class="table-row hover:bg-indigo-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a target="_blank" href="/service/details/{{$value->id}}">
                                    ...
                                    <button onclick = "openmodaledit({{$value->id}},'{{$value->titre}}','{{$value->Description}}',{{$value->Prix}},'{{$value->CategorieNom}}',{{$value->duration}},'red')" class="text-indigo-600 hover:text-indigo-900 mx-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
