...
@section('Services', 'bg-indigo-100 text-indigo-600') 
 ...
 <main class="main-content flex-1 overflow-x-hidden overflow-y-auto bg-gray-50">
            ...
            <header class="bg-white shadow-sm px-6 py-4 flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <h2 class="text-xl font-semibold text-gray-800">Modification de Service</h2>
                </div>
            ...
            <div class="p-6 fade-in">
                ...
                <div class="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100 mb-8">
                    ...
                    <div id="secondform">
                        ...
                        <p class="text-sm text-gray-500 mt-1">Veuillez modifier les champs nécessaires.</p>
                    </div>
                    @if($errors->all())
                    ...
                    <form class="p-6 space-y-8" method="POST" action="/professional/edit/service/{{$services->id}}" enctype="multipart/form-data" autocomplete="off">
                        @csrf 
                        @method('PUT')
                        <div>
                            <label for="categoryName" class="block text-sm font-medium text-gray-700 mb-2">Nom de Service *</label>
                            <input value = "{{$services->titre}}" type="text" id="name" name="name" required value="Service de coiffure"
                        ...
                        <div>
                            ...
                            <textarea value = "{{$services->Description}}" id="description" name="description" rows="4"
                                class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
                                placeholder="Entrez une description détaillée de Service">Service de coiffure professionnel pour hommes et femmes avec des produits de qualité supérieure.</textarea>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input value = "{{$services->Prix}}" type="number" id="Prix" name="prix" step="0.01" value="45.00"
                        ...
                        <div>
                            ...
                            <div class="mb-3">
                                ...
                                <img src="/storage/{{$services->Photo}}" alt="Service de coiffure" class="w-32 h-32 object-cover rounded-lg">
                            </div>
                        ...
                        <div class="border-t border-gray-100 pt-6">
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <input type="text" id="metaTitle" name="metaTitle" value="Service de coiffure professionnelle | Nom du salon"
                                        class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
                                ...
                                <div>
                                    ...
                                    <textarea id="metaDescription" name="metaDescription" rows="2"
                                        class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
                                        placeholder="Meta description pour SEO">Profitez d'un service de coiffure professionnel pour hommes et femmes. Nos coiffeurs expérimentés vous offrent un service personnalisé avec des produits de qualité.</textarea>
                                </div>
                            </div>
                        </div>
