            ...
            <div class="h-full flex flex-col">
                ...
                <nav class="flex-1 py-4 overflow-y-auto">
                    <div class="px-3 space-y-1">
                        <a href="/admin/dashboard" class="@yield('home') group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-gray-700 hover:bg-indigo-50 hover:text-indigo-700">
                        ...
                        <a href="/admin/services" class="@yield('Services') group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-gray-700 hover:bg-indigo-50 hover:text-indigo-700">
                            <i class="fas fa-briefcase mr-3 text-gray-400 group-hover:text-indigo-500"></i>
                            Services
                        </a>
                        <a href="/admin/rendez-vous" class="@yield('Rendez-vous') group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-gray-700 hover:bg-indigo-50 hover:text-indigo-700">
                            <i class="fas fa-calendar-alt mr-3 text-gray-400 group-hover:text-indigo-500"></i>
                            Rendez-vous
                        </a>
                        <a href="/admin/avis" class="@yield('Avis') group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-gray-700 hover:bg-indigo-50 hover:text-indigo-700">
