        ...
        <aside class="bg-white w-64 shadow-lg h-full flex-shrink-0 z-20 border-r border-gray-200">
            <div class="h-full flex flex-col">
                ...
                <nav class="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
                    ...
                    <a href="/admin/avis" class="@yield('Avis') flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-600 hover:bg-gray-50 hover:text-indigo-600 transition-colors">
