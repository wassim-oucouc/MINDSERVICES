        ...
        <div class="lg:grid lg:grid-cols-3 lg:gap-8">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="rounded-xl overflow-hidden shadow-lg mb-8">
                    <img src="/storage/{{$service->Photo}}" alt="" class="w-full h-full object-cover">
                </div>
                ...
                <div class="bg-white rounded-xl p-6 shadow-md mb-8 border-l-4 border-indigo-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900">{{$service->Prix}}€<span class="text-gray-500 text-xl font-normal">/heure</span></p>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden sticky top-6">
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <h4 class="text-lg font-medium text-gray-900">{{$service->Prestataire->Prenom}} {{$service->Prestataire->Nom}}</h4>
                                <p class="text-gray-600">Prestataire certifié</p>
                                <div class="flex text-yellow-400 mt-1">
    @if ($AvisAverage >= 1)
        <i class="fas fa-star"></i>
    @elseif ($AvisAverage >= 0.5)
    ...
    <span class="ml-2 text-gray-600 text-xs">{{ $AvisAverage }}</span>
                        ...
                        <div class="mt-4 space-y-2">
                            <div class="flex items-center">
                                ...
                                <span class="ml-2 text-sm text-gray-600">Service garanti
                                </span>
                            </div>
                            <div class="flex items-center">
                                <i class="fas fa-certificate text-green-500 w-5"></i>
                                <span class="ml-2 text-sm text-gray-600">Intervention rapide
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="p-6 bg-gray-50 border-t border-gray-100">
                        ...
                        <p class="text-xs text-gray-500 mt-2 text-center">
                            Réservation gratuite, paiement en protection
                        </p>
                    </div>
